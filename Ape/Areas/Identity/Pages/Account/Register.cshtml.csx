...
namespace Ape.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string? returnUrl = null)
        {
            ...
            {
                Input.City = Environment.GetEnvironmentVariable("DEFAULT_CITY_FISH_SMARTx") ?? string.Empty;
            }
            if (string.IsNullOrEmpty(Input.State))
            {
                Input.State = Environment.GetEnvironmentVariable("DEFAULT_STATE_FISH_SMARTx") ?? string.Empty;
            }
            if (string.IsNullOrEmpty(Input.ZipCode))
            {
                Input.ZipCode = Environment.GetEnvironmentVariable("DEFAULT_ZIPCODE_FISH_SMARTx") ?? string.Empty;
            }
        }
