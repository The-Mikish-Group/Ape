...
namespace Ape.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel(
        ...
        SecureConfigurationService configService) : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(IdentityUser user)
        {
            ...
            AuthenticatorUri = await GenerateQrCodeUriAsync(email, unformattedKey);
        }
        ...
        private async Task<string> GenerateQrCodeUriAsync(string email, string unformattedKey)
        {
            string siteDomain = await _configService.GetCredentialAsync("SITE_DOMAIN") ?? "Ape";
