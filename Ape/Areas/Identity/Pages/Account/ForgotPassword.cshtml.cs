...
{
    public class ForgotPasswordModel(UserManager<IdentityUser> userManager, IEmailSender emailSender, SecureConfigurationService configService, ILogger<ForgotPasswordModel> logger) : PageModel
    {
